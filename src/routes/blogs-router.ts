...
const nameLengthValidation = body('name').trim().isLength({max: 15}).withMessage("Name should be less 15 symbols");
const youtubeUrlLengthValidation = body('youtubeUrl').isLength({max: 100}).withMessage("YoutubeUrl should be less 100 symbols");
