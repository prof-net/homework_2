...
const titleLengthValidation = body('name').trim().isLength({max: 30}).withMessage("Title should be less 30 symbols");
const shortDescriptionLengthValidation = body('shortDescription').trim().isLength({max: 100}).withMessage("ShortDescription should be less 100 symbols");
const contentLengthValidation = body('content').trim().isLength({max: 1000}).withMessage("Content should be less 1000 symbols");
