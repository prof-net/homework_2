...
export const emailManager = {
    async sendEmailConfirmationMessage(email: string, confirmationCode: string, frontHost:string) {
        ...
        const emailBody = `<h1>Thank for your registration</h1> <p>To finish registration please follow the link below: <a href='https://somesite.com/confirm-email?code=your_confirmation_code?code=${confirmationCode}'>complete registration</a> </p>`;
