...
export const emailManager = {
    async sendEmailConfirmationMessage(email: string, confirmationCode: string, frontHost:string) {
        ...
        const emailBody = `<h1>Thank for your registration</h1> <p>To finish registration please follow the link below: <a href='https://${frontHost}/confirm-email?code=${confirmationCode}'>complete registration</a> </p>`;
